...
begin
   ...
   crear_sublistaed_primos(L1, L1p); -- Los primos de L1
   New_Line; New_Line;
   ...
   -- Crear lista de enteros decrecientes primos Lp con los 5 primeros pares del 2 al 8
   ...
   if listased.Igual(Lp1, L1p) then
      Put_Line("La lista Lp1 y la obtenida como sublista decreciente de primos L1p son iguales");
      Escribir_Contenidos(L1p, "L1p", Lp1, "Lp1");
   else
      Put_Line("La lista Lp1 y la obtenida como sublista decreciente de primos NO son iguales");
      -- Contenido de L1p
      Put("===> ");
